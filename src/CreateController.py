...
class ThreeJntChain:
    ...
    def RigThreeJntChain(self):
        ...
        ikfkBlendCtrl = "ac__" + self.root + "_ikif_blend"
        ...
        mc.connectAttr(ikfkReverse + ".outputX", rootCtrl + ".v")
...
threeJntChainWiget = ThreeJntChainWiget()
threeJntChainWiget.show()
