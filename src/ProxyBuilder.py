...
class BuildProxy:
    ...
    def BuildProxyForSelectedmesh(self):
        ...
        for jnt, verts in jntVertsMap.items():
            ...
            mc.copySkinWeights(ss=self.skin,ds = newSkinCluster, nm = True, sa = "closestPoint", ia = "closesPJoint")
        ...
        globalProxyCtrl = "ac_" + self.model + "proxy_global"
        ...
        mc.addAttr(globalProxyCtrl, ln = "vis", min = 1, max = 1 , k = True, d = 1)
    ...
    def CreateProxyModelForJntAndVerts(self, jnt, verts):
        ...
        faces = mc.ls(faces, flattten = True)
